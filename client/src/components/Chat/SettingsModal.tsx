...
export const SettingsModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-2xl animate-fade-in select-none">
      <div className="relative w-full max-w-2xl bg-[#0E0E10] rounded-3xl border border-white/20 shadow-2xl overflow-hidden animate-slide-up max-h-[92vh] flex flex-col">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-bold text-white tracking-tight flex items-center gap-2">
                ...
                <span className="text-[9px] uppercase font-bold text-black bg-white px-1.5 py-0.2 rounded">
                  PRO
                </span>
              </h2>
            </div>
