  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-xl animate-fade-in select-none">
      ...
      <div className="absolute top-0 inset-x-0 p-4 flex items-center justify-between bg-gradient-to-b from-black/60 to-transparent z-10">
        <div className="text-sm font-medium text-white/80 truncate max-w-md px-2">
          {lightboxImage.name}
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-brand-rose/20 hover:bg-brand-rose/40 text-brand-pink transition ml-2"
            title="Close (Esc)"
          >
            <X className="w-4 h-4" />
          </button>
