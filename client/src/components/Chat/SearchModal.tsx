...
export const SearchModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/85 backdrop-blur-2xl animate-fade-in select-none">
      <div className="relative w-full max-w-lg bg-[#0E0E10] rounded-t-3xl sm:rounded-3xl border-t sm:border border-white/20 shadow-2xl overflow-hidden animate-slide-up max-h-[85vh] sm:max-h-[85vh] flex flex-col pb-safe">
        {/* Mobile Pull Handle */}
        <div className="w-12 h-1 bg-white/20 rounded-full mx-auto mt-2.5 sm:hidden flex-shrink-0" />

        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-white/10 flex items-center justify-between flex-shrink-0 bg-[#141416]">
        ...
        {/* Search & Filter Form */}
        <form onSubmit={handleSearch} className="p-4 sm:p-5 border-b border-white/10 space-y-3 flex-shrink-0 bg-[#0E0E10]">
          {/* Query Bar */}
